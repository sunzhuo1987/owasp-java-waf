...
public class IPRule extends Rule {
	...
	public IPRule(String id, Pattern allowedIP, Pattern path, String ipHeader, Action ruleDefaultAction) {
	...
	public IPRule(String id, Pattern allowedIP, String exactPath, Action ruleDefaultAction) {
		this.path = null;
