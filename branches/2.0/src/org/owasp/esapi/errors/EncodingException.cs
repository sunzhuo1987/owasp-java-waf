...
namespace org.owasp.esapi.errors
{
	...
	public class EncodingException:EnterpriseSecurityException
	{
		...
		/// </param>
		public EncodingException(System.String userMessage, System.String logMessage):base(userMessage, logMessage)
		{
		}
		...
		public EncodingException(System.String userMessage, System.String logMessage, System.Exception cause):base(userMessage, logMessage, cause)
		{
		}
	}
}